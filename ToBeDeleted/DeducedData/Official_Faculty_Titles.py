...
class OfficialFacultyTitles:
    def __init__(self, csv_path: str):
        ...
        self.construct_official_faculty_titles_and_dept(
            self.df,
            self.offical_faculty_titles_and_dept_dict,
            self.mapping_abbr_name_actual,
        )
        self.official_faculty_titles_set: set[str] = (
            self.construct_official_faculty_titles_set(
                self.offical_faculty_titles_and_dept_dict
            )
        )

    @staticmethod
    def construct_official_faculty_titles_and_dept(
        df: pd.DataFrame, data_dict: dict[str, str]
    ) -> None:
    ...
    @staticmethod
    def construct_official_faculty_titles_set(
...
if __name__ == "__main__":
    of = OfficialFacultyTitles(
        csv_path="/mnt/linuxlab/home/spresley1/Desktop/425Reset/Rommel-Center-Research/PythonCode/DeducedData/Files/professor_department_dump.csv"
    )
