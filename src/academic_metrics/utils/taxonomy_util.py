...
class Taxonomy:
    def __init__(self) -> None:
        self.taxonomy: TaxonomyDict = self._load_taxonomy_from_string(TAXONOMY_AS_STRING)
...
if __name__ == "__main__":
    ...
    for top_category in top_categories:
        ...
        for mid_category in mid_categories:
            low_categories: List[str] = taxonomy.get_low_categories(top_category, mid_category)
            print(f"mid category: \n{mid_category}, \nlow categories: \n{low_categories}\n")
        print("\n\n")
