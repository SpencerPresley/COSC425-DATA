...
sys.path.append(
    "/mnt/linuxlab/home/spresley1/Desktop/425Reset/Rommel-Center-Research/PythonCode"
)
...
class FuzzyMatcher:
    def __init__(self):
        self.category_dict: dict[str, CategoryInfo] = PickleDictLoader(
            "/mnt/linuxlab/home/spresley1/Desktop/425Reset/Rommel-Center-Research/PythonCode/Utilities/category_dict.pkl"
        ).get_loaded_dict()
