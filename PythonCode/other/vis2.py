...
class CollaborationNetworkApp(QtWidgets.QMainWindow):
    def __init__(self, threshold):
        ...
        sample_articles = list(articles_df['math']['article_citation_map'].items())[:20]  # Take only the first 20 articles
    ...
    def draw_network(self):
        ...
        node_item = pg.ScatterPlotItem(node_positions[:, 0], node_positions[:, 1], size=10, brush=pg.mkBrush(255, 0, 0, 120))
