...
sys.path.append("/home/jude/425Project/COSC425-DATA-FORK-1")
...
class AbstractCategoryMap:
    def __init__(self, Utilities_obj: object, *, dir_path: str):
        ...
        self.file_ops = FileOps(
            output_dir="/home/jude/425Project/COSC425-DATA-FORK-1/PythonCode/Utilities"
        )
    ...
    def map_abstract_categories(self, *, dir_path: str):
        ...
        for filename in os.listdir(dir_path):
            ...
            abstract, categories = self.extract_abstract_and_categories(
