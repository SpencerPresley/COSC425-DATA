    ...
    for category, faculty_stats in data.items():
        if 'faculty_stats' in faculty_stats:
            for faculty, details in faculty_stats['faculty_stats'].items():
                if 'citation_map' in details and 'article_citation_map' in details['citation_map']:
                    for article, citation_count in details['citation_map']['article_citation_map'].items():
                        all_data.append({
                            'Category': category,
                            ...
                            'Average Citations': details.get('average_citations', 0),
