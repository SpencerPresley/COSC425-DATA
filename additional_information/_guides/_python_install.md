...
1. Create a new virtual environment:
   ...
   **macOS/Linux**:
    ...
    > [!TIP]  
    > There's a useful tip outlined in step 3 of the [Common Issues](#common-issues) section about **aliasing** the `python` and `pip` commands to use the version you'd like to use, it will streamline the below process and only takes a couple of seconds to do.
    >
